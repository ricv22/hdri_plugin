...
**Notebook + public domain (`https://api.richardandrys.com`) + RunComfy:** configure `.env` and bind to all interfaces so a tunnel can reach the app; see [NOTEBOOK_DOMAIN_SETUP.md](../NOTEBOOK_DOMAIN_SETUP.md).
