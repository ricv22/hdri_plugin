...
const translations = {
  cs: {
    ...
    "service.shots.copy": "Tracking, keying, integrace CG a grading pro náročnější záběry v reklamě a brand filmech.",
    ...
    "about.statement": 'Jsem <mark>3D artist</mark>. Dělám produktové vizuály, animace a VFX pro značky, agentury a kampaně — aby produkt vypadal co nejlépe, <mark>snímek po snímku</mark>.',
  ...
  en: {
    ...
    "service.shots.title": "Shot finishing",
    "service.shots.copy": "Tracking, keying, CG integration and grading for demanding commercial and brand film shots.",
    ...
    "about.statement": 'I\'m a <mark>3D artist</mark>. I create product visuals, animation and VFX for brands, agencies and campaigns — making products look their best, <mark>one frame at a time</mark>.',
...
const personaServiceCards = document.querySelectorAll("[data-persona-show]");

function applyServiceCards() {
  personaServiceCards.forEach((card) => {
    const showFor = card.getAttribute("data-persona-show");
    card.hidden = showFor !== currentAudience;
  });
}
